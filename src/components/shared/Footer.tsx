    ...
    return (
        <footer className="mt-4 flex flex-col items-center justify-center bg-secondary p-16 text-light dark:bg-darksecondary">
            <ul className="lg:6/12 xl:6/12 2xl:6/12 mb-8 flex justify-center gap-4 sm:w-full md:w-full">
                <li className="flex h-16 w-16 cursor-pointer items-center justify-center bg-primary hover:bg-detail dark:bg-darkprimary dark:text-light dark:hover:bg-dark">
                    <a
                        target="_blank"
