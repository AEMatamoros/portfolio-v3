...
const Techs: React.FC = () => {
    const TECHS = [
        {
            ...
            icon: (
                <svg
                    ...
                    viewBox="0 0 452 520"
                    className="h-12 w-12   fill-slate-600 md:h-24 md:w-24"
                >
        ...
        },
        {
            ...
            icon: (
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 32 32"
                    className="fill-gray h-12 w-12  fill-slate-600 md:h-24 md:w-24"
                >
    ...
    return (
        <section className="items-left m-auto flex  w-10/12 flex-col justify-center py-4 md:w-8/12">
            <div className="mt-28 flex flex-wrap items-center justify-center gap-5 px-16 max-md:mt-10 max-md:max-w-[1280px]">
                {TECHS.map(tech => (
                    <div key={tech.name} className="cursor-pointe">
                        {tech.icon}
                    </div>
                ))}
            </div>
